...
export default function CartContainer({ cartList, setCartList }) {
  ...
  return (
    <div className="mt-16 min-w-full p-10 border border-solid border-gray-300 rounded-md">
      {cartList.length === 0 ? (
        ...
        <>
          ...
          {cartList.map((cartItem, index) => (
            <div
              key={index}
              className="flex flex-row items-center justify-between gap-4 bg-[#F9FAFC] py-4 px-8 rounded-md"
            >
