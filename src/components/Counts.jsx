export default function Counst() {
  return (
    <div className="md:px-32 mt-10 lg:mt-0 bg-linear-to-r from-[#4F39F6] to-[#9514FA] py-16 flex flex-row items-center justify-center text-white md:gap-10 lg:gap-20">
